<template>
  <div class="audio-services">
    <div class="audio-services__title">Audio Services</div>
    <div class="audio-services__services">
      <div class="audio-services__service">
        <div class="audio-services__service-name">
          <img :src="require(`@/assets/svg/poems.svg`)" alt="Audio" />
          <div class="audio-services__service-title">Generating text in audio</div>
        </div>
        ...
        <Transition>
          <div v-if="hints.audio" class="audio-services__hint">
            <i
              @click="showHint({ value: false, hintName: 'audio' })"
              class="pi pi-times-circle audio-services__close-btn"
              style="font-size: 1.4rem"
            />

            <div>
              <span class="audio-services__hint-title">How to use:</span>
              <div class="audio-services__hint-text">
